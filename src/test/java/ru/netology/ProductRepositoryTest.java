...
public class ProductRepositoryTest {
    ...
    Product product2 = new Product(22, "Product2", 80_000);
    Product product3 = new Product(33, "Product3", 40_000);
    Product product4 = new Product(44, "Product4", 20_000);
    Product product5 = new Product(55, "Product5", 100);
    Product product6 = new Product(66, "Product6", 9_500);
